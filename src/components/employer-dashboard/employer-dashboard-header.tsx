...
import { LogOut, Settings, User, Bell, Sparkles, Plus } from "lucide-react";
      ...
      <div className="flex h-16 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Button
              className="gap-2"
              onClick={() => router.push("/employer/dashboard/jobs/new")}
            >
          ...
          >
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => router.push("/employer/dashboard/profile")}>
                ...
                <DropdownMenuItem onClick={() => router.push("/employer/dashboard/settings")}>
